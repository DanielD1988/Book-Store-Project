...
public class UpdateListener implements ActionListener{
	...
	public void actionPerformed(ActionEvent e) {
		if(e.getSource() == submit) {
			...
			/*if(firstName.equals("?") || lastName.equals("?")|| road.equals("?")|| count.equals("?")|| countr.equals("?")|| emai.equals("?")|| phon.equals("?")) {
			...
			if(!customerId.equals("")){
				try {
					...
					if(!lastName.equals("") && id != 0 && !lastName.equals("?")) {
						customerTable.updateLName(lastName, id);
					}
					if(!road.equals("") && id != 0 && !road.equals("?")) {
						customerTable.updateStreet(road, id);
					}
					if(!cityTown.equals("") && id != 0 && !cityTown.equals("?")) {
						customerTable.updateTownCity(cityTown, id);
					}
					if(!count.equals("") && id != 0 && !count.equals("?")) {
						customerTable.updateCounty(count, id);
					}
					if(!countr.equals("") && id != 0 && !countr.equals("?")) {
						customerTable.updateCountry(countr, id);
					}
					if(!emai.equals("") && id != 0 && !emai.equals("?")) {
						customerTable.updateEmail(emai, id);
					}
					if(!phon.equals("") && id != 0 && !phon.equals("?")) {
